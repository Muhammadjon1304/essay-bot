...
# Database configuration - Support Railway and local development
...
if DATABASE_URL:
    ...
    # Try Railway individual variables (PGHOST, PGUSER, etc.)
    ...
    if PGHOST:
        ...
        def get_connection():
            """Get database connection from Railway PG variables"""
            try:
